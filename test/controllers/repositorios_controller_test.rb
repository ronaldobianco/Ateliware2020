...
class RepositoriosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repositorio" do
    assert_difference('Repositorio.count') do
      post repositorios_url, params: { repositorio: { data: @repositorio.data, descricao: @repositorio.descricao, img: @repositorio.img, name: @repositorio.name, text: @repositorio.text } }
    end
  ...
  test "should update repositorio" do
    patch repositorio_url(@repositorio), params: { repositorio: { data: @repositorio.data, descricao: @repositorio.descricao, img: @repositorio.img, name: @repositorio.name, text: @repositorio.text } }
